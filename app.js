...
app.post("/cadastrar", function(req, res){
    post.create({
        nome: req.body.nome, //nome: -> é o do post.js e .nome -> name no input no handlebars
...
app.get("/consulta", function(req, res){ //get busca ou mostra algo
    post.findAll().then(function(posts){ //post alterar algo
